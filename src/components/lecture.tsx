...
export default function Lecture() {
  ...
  const deleteService = async (id: any) => {
    const response = await axios.delete(
      `${url.url}admin/deleteLecture/${id}`
    );
          ...
          <div className="flex gap-2">
            <div className="w-[210px]">
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="Filter Service">Lecture</SelectItem>
                    <SelectItem value="Filter Catalog">Course Name</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
            </div>
